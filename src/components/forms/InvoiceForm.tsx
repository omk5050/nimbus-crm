...
import { invoiceFormSchema } from '@/pages/sales/sales.schemas';
import type { InvoiceFormValues } from '@/types/sales.types';
...
const EMPTY_DEFAULT_VALUES: InvoiceFormValues = {
  customerId: '',
  dealId: '',
  dueDate: '',
  notes: '',
...
export function InvoiceForm({ formId, defaultValues, onSubmit }: InvoiceFormProps) {
